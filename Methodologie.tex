...
Afin de protéger le cookie contre d'éventuels vols de données, celui-ci doit être paramétré 
...
Si le code nécessite de rediriger vers une page externe, le code peut vérifier que celle-ci appartient bien à une liste blanche en utilisant la classe \textbf{DbContext}.
\begin{Config}{csharp}{.NET: Vérification par liste blanche}
//var db = new DbContext();
// [...]
var uri= Request.QueryString["Uri"];
...
\subsubsection{Direct Access Reference}
