...
\itemÉtablir l'importance de l’application au sein l'entreprise ou de l’entité concernée
\itemÉtablir les limites du périmètre de l’application concernée
\itemÉtablir les risques potentiels et les contrôles possibles liée au contexte métier du client
\item[\textbf{A}]nalyse: 
...
\item Injection en base de données
\item Injection de code brut
