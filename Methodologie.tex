...
\subsubsection{Utilisation de Prepared Statement}
Avec \gls{J2EE}, la classe PreparedStatement représente une instruction SQL précompilée qui peut être exécuté plusieurs fois sans avoir à être recompiler pour chaque exécution.
