...
\begin{Define}{Chiffrement par bloc}
...
De nombreuses attaques ont été publiées contre les chiffrements par blocs de 64 bits qui impactent notamment l'implémentation 3DES et DES. Un attaquant ayant connaissance de suffisamment de ciphertext sera en mesure de déterminer le plaintext en partant de la connaissance d'un bloc en clair. Depuis 2000, le standard requiert une taille de bloc de 128 bits.\\

\begin{Define}{key schedule}
...
\end{Define}
\begin{Warning}
Un réseau de Feistel où L et R sont de taille différente est appelé \textit{unbalanced}.
\end{Warning}
