...
% Parler des recommendations du NIST

\subsubsection{Base de registre}
La configuration des systèmes Windows est en grande partie stockée dans la base de registre Windows (ou Registre Windows), une base de donnée interne au système. Cette base de donnée est divisée
% fichier de la base de donnée stocké dans %SystemRoot%\System32\config
...
\pshell{netsh advfirewall show allprofile}% ajouter une boite pour expliquer l'outil netsh
...
% Prendre en compte tous les composants aditionnels
% Bitlocker
%
