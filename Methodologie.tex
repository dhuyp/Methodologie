...
\begin{FlagConsole}{Lister les utilisateurs avec MySQL}
	...
	Il est à noter que MySQL peut utiliser un algorithme de hachage interne MySQL-SHA. Cet algorithme se reconnait à l'utilisation d'une astérisque avant le condensat.\tcblower
