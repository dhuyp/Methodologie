...
\DeclareTotalTCBox{\pshell}{ v }{verbatim,colupper=white,colback=blue!75!white,colframe=blue}
{\textcolor{white}{\ttfamily\bfseries PS > }\lstinline[language=powershell,keywordstyle=\color{green!35!white}\bfseries]^#1^}
