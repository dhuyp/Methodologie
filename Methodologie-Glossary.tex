...
\newdualentry{EPC}{EPC}{European Payments Council}{Le Conseil Européen des paiements est une initiative pan-européenne pour faciliter la mise en place des échanges dans la zone euro (SEPA). C'est un interlocuteur priviligié avec les instances de l'Union Européenne.}
